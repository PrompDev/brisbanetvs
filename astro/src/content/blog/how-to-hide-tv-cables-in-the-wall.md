...
tags: ["cable management", "installation", "tv mounting", "how-to"]
readTime: 7
draft: false
---
...
1. **Fish the HDMI and low-voltage data through the wall cavity.** Safe, simple, and legal. This covers your HDMI, ethernet, optical audio, and speaker wire.
2. **Install a recessed power-relocation kit** so the existing wall outlet feeds the TV from behind. The only legal way to get mains power up the wall without an electrician.

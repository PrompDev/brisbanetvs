...
style: "custom"
suburb: "New Farm"
service: "Feature Install"
tags: ["large TV", "98 inch", "cable concealment", "new farm"]
readTime: 8
draft: false
---
...
1. One **recessed power-relocation kit** behind the TV, feeding from the existing console-height outlet. This keeps mains power legal and within building code.
2. A **low-voltage brush plate** at TV height and console height, with HDMI 2.1 and ethernet fished through the cavity between them.
3. A **cable-tidy sleeve** inside the cavity so everything stays separated from the power line.

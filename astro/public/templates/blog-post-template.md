---
# ============================================================
# Brisbane TVs â€” Blog Post Briefing & Template
# ============================================================
...
#      drafting a post â€” read the whole file before writing.
#   3. A worked example, shown at the bottom, that a valid post
#      can be copy-pasted from.
#
# Every section in the WRITING BRIEF below is load-bearing â€” if
...
# WRITING BRIEF â€” read this before drafting
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
#
# ## Who this is for
...
# - 8â€“120 characters. Zod will reject outside this range.
...
# - No clickbait ("You Won't Believeâ€¦"), no list-count padding
#   ("Top 10 Amazingâ€¦"), no em-dash-cluster headings.
#
# ## Description rules (frontmatter: description)
# - 40â€“200 characters. Zod will reject outside this range.
# - This is the meta description â€” it's the click-through pitch on
...
#
# ## H2 structure (body)
# - 4â€“7 H2 headings in the body. Each H2 maps to a real sub-question
#   the reader has, written in plain-English question form where natural.
# - Order matters. A strong pattern is:
#     H2 #1 â€” "What you're actually asking about" (reframe the problem)
#     H2 #2 â€” "Why this is harder than it looks" (expertise signal)
#     H2 #3 â€” "How we do it" (method, numbered steps where useful)
#     H2 #4 â€” "What it costs in Brisbane" (local pricing, concrete floor)
#     H2 #5 â€” "What can go wrong" or "When NOT to do this" (honesty)
#     H2 #6 â€” "Frequently asked" (FAQ block â€” Google surfaces FAQ rich
#             results for these)
...
#   an automatic drop-cap on the custom layout if it's â‰¥40 chars, so
#   make it count.
...
# - Weave 2â€“4 related keywords ("related terms" from a SERP scan)
#   naturally through the body. If it feels forced, it is â€” rewrite.
...
#   - A tel: link to 0432 145 101 somewhere in the body.
#   - A link to /quote/ as the primary CTA.
# Anchor text must be natural â€” never "click here".
#
# ## Trust markers (weave in, don't list)
# - 5-year warranty on every install.
# - 109 Brisbane suburbs covered.
# - Brisbane-only â€” not a franchise, not a national chain.
# - Installers answer the phone on 0432 145 101.
# Mention at least two of these in every post, in context, not as a
# boilerplate paragraph.
#
# ## Length + readTime
# - Sweet spot: 1,200â€“1,800 words for most service guides, 800â€“1,200
...
#     Wide landscape, 16:9 or wider, â‰¥1600px on the long edge.
#     The finished install in context â€” TV on, room lit, no visible
#     cables, whole wall or room visible (not a close-up).
#     This is above the fold. It carries the most SEO weight.
#
#   - INLINE-1 (required)
#     Placed after the opening 2â€“3 paragraphs.
...
#     A process or detail shot â€” cable run, mount detail, close-up
#     of the tricky bit. Something that shows expertise.
#
#   - INLINE-3 (recommended for posts â‰¥1,200 words)
...
#   but high-impact â€” captions are read by more people than body copy,
...
#      Use slot names inline-1, inline-2, inline-3â€¦ in order.
#
...
#      â€” one line per placeholder, with a short instruction to the
#      photographer/user. Example:
#
#        Images needed for this post:
#        1. hero â€” Wide landscape of finished install, TV on, warm lighting
#        2. inline-1 â€” Wall cut open showing lath-and-plaster, tape for scale
#        3. inline-2 â€” Cable run through old chimney flue, close-up
#        4. inline-3 â€” Finished install viewed from adjoining dining room
#
...
#
# ============================================================
# FRONTMATTER â€” every CMS field, in CMS order
# ============================================================

# Title â€” REQUIRED. 8â€“120 characters.
title: "Your Post Title Goes Here"

# Description â€” REQUIRED. 40â€“200 characters. Meta description / preview.
description: "One- or two-sentence pitch that sets up the reader's problem and promises the payoff. Specific beats clever â€” include a number, price, or method."

# Hero image â€” REQUIRED. Use IMAGE:hero placeholder; the uploader
# rewrites this to a real /media/ path on save.
heroImage: "IMAGE:hero"

# Hero alt â€” REQUIRED. Min 8 chars. Literal first, keyword-natural second.
heroAlt: "Describe what is literally in the hero image, in one sentence"

# Publish date â€” REQUIRED. ISO datetime with timezone (CMS format) or
# plain YYYY-MM-DD. Drives sort order on /blog/.
publishDate: 2026-04-19T09:00:00.000+10:00

# Updated date â€” OPTIONAL. Set when you meaningfully revise the post.
updatedDate: 2026-04-19T09:00:00.000+10:00

# Author â€” OPTIONAL. Defaults to "Brisbane TVs Team".
author: "Brisbane TVs Team"

# Style â€” REQUIRED. Layout selector. Must be EXACTLY one of:
#   custom        â€” magazine-style long-read (default, recommended)
#   standard      â€” plain article layout
#   service-guide â€” how-to / step-by-step
#   location      â€” suburb / area-specific landing
# NOTE: key is `style`, NOT `layout` (Astro treats `layout:` as a
# magic import path and breaks the build).
style: "custom"

# Suburb â€” OPTIONAL. Required feel for style: location posts.
suburb: ""

# Service â€” OPTIONAL. Required feel for style: service-guide posts.
service: ""

# Tags â€” OPTIONAL. String array for filtering on /blog/. Leave as []
# for none â€” do NOT delete the field.
tags: []

# Draft â€” OPTIONAL. true keeps the post OUT of the live build.
draft: false

# Read time â€” OPTIONAL. Whole minutes only. Shown in the byline.
readTime: 7

# Image briefs â€” OPTIONAL but REQUIRED IF you use IMAGE:<slot> placeholders.
# Array of { slot, description, alt } entries. Slot strings must match the
# IMAGE:<slot> tokens you used (e.g. slot "hero" â†’ IMAGE:hero). The uploader
...
imageBriefs:
  ...
  - slot: "inline-1"
    description: "Before-shot or setup-shot â€” what the space looked like before we intervened, or the problem being opened up"
    alt: "Literal alt for the before/setup shot"
  - slot: "inline-2"
    description: "Process or detail shot â€” cable run, mount detail, close-up of the tricky bit that shows expertise"
...
Write the opening hook here in the first paragraph â€” lead with the reader's
...
![Literal description of the before or setup image, keyword-natural](IMAGE:inline-1 "A short caption â€” concrete detail or outcome, not a description.")

## H2 #1 â€” Reframe the actual question

Answer in 2â€“4 paragraphs. Include at least one internal link to a
relevant [service page](/services/) or [suburb page](/locations/).

## H2 #2 â€” Why this is harder than it looks

Show expertise. Numbers, materials, edge cases. This is where posts
earn their ranking â€” most competitors skip this section, which is why
they lose.

## H2 #3 â€” How we actually do it
...
## H2 #4 â€” What this costs in Brisbane

Give a concrete price floor ("from $179") and say what drives it up
(TV size, wall type, cable run length). Include a [quote link](/quote/)
or a tel: link to [0432 145 101](tel:+61432145101) here â€” the reader is
at peak intent in a pricing section.

## H2 #5 â€” What can go wrong

Honesty signal. List 3â€“5 real failure modes and how we avoid each. This
is a conversion section â€” trust compounds in the paragraphs where
...
and links to [/quote/](/quote/) or references `0432 145 101` one last time.

---

# ============================================================
# WORKED EXAMPLE â€” reference only, do not ship as-is
# ============================================================
...
#   ---
#
# (Body of example post omitted â€” the pattern from the template body
# above applies.)
# ============================================================

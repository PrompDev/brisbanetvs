...
function publicPageUrl(value) {
  ...
  try {
    const url = new URL(text, "https://brisbanetvs.com");
    const host = url.hostname.toLowerCase();
    const isProduction = host === "brisbanetvs.com" || host === "www.brisbanetvs.com";
    const isPreview = host === "brisbanetvs.pages.dev";
    if (url.protocol !== "https:" || (!isProduction && !isPreview)) return "";
    const origin = isProduction ? "https://brisbanetvs.com" : url.origin;
